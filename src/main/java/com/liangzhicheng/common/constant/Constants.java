...
public interface Constants {
    ...
    public static String WECHAT_MINI_MCH_ID = ""; //微信支付商户号
    //小程序密钥(在商户平台设置，登录后——账户中心——账户设置——API安全中设置)：WECHAT_MINI_APP_SECRET
    public static String MINI_NOTIFY_URL = "http://xxx/client/payClientController/weChatMiniPayNotify"; //异步通知支付结果Url
    /**
     * WeChat APP支付
     */
    public static String WECHAT_APP_APP_ID = ""; //微信支付申请成功后在邮件中的APPID
    public static String WECHAT_APP_MCH_ID = ""; //微信支付商户号
    public static String WECHAT_APP_SECRET = ""; //密钥(在商户平台设置，登录后——账户中心——账户设置——API安全中设置)
    public static String APP_NOTIFY_URL = "http://xxx/client/payClientController/weChatAppPayNotify"; //异步通知支付结果Url
    /**
     * WeChat扫码支付
     */
    ...
    public static String PATH_CERT = "/opt/ideaShow/cert/apiclient_cert.p12"; //linux
    ...
    //开放平台——右上角主账号——密钥管理
    public static String ALIPAY_APP_APP_ID = "";
    //开放平台——右上角主账号——密钥管理——左上角账户账户管理
    public static String ALIPAY_APP_PARTNER = "";
    //收款支付宝账号
    public static String ALIPAY_APP_PAYEE_EMAIL = "";
    //商户的安全校验码（合作伙伴密钥管理）
    ...
    public static String SIGN_TYPE_APP = "RSA2";
    ...
    //异步通知支付结果Url
    public static String ALIPAY_APP_NOTIFY_URL = "http://xxx/client/payClientController/alipayAppNotify";
