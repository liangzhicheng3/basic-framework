...
/**
 * @description 身份证获取出生地工具类
 * @author liangzhicheng
 * @since 2021-03-05
 */
public class SysBirthPlaceUtil {
    ...
    public static String getBirthPlace(String cardNo) {
        ...
        String birthPlace = "";
        if (SysToolUtil.isNotBlank(province)) {
            birthPlace += province;
        }
        if (SysToolUtil.isNotBlank(city)) {
            birthPlace += city;
        }
        if (SysToolUtil.isNotBlank(district)) {
            birthPlace += district;
        }
        return birthPlace;
    }
