...
@RequestMapping("/api/${entity?uncap_first?replace('Entity','WebController')}")
<#if kotlin>
...
public class ${table.controllerName} {
    ...
    public ResponseResult page(@ApiParam(value = "页码，1为第一页",required = true) @RequestParam Integer page,
