...
CREATE TABLE `sys_role_user`(
  `id`                   VARCHAR(19) NOT NULL COMMENT '角色用户id(主键)',
  `role_id`              VARCHAR(19) NOT NULL COMMENT '角色id',
  `role_name`            VARCHAR(30) NOT NULL COMMENT '角色名称',
  `account_id`           VARCHAR(19) NOT NULL COMMENT '账号id',
...
-- ----------------------------
INSERT INTO `sys_role_user` (id, role_id, role_name, account_id, account_name, create_date, update_date)
...
CREATE TABLE `sys_user` (
  `id`                   VARCHAR(19) NOT NULL COMMENT '账号id(主键)',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` (id, dept_id, dept_name, account_name, truename, password, is_admin, create_date, update_date)
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` (id, name, description, create_date, update_date) VALUE ('1', '总经办', '负责总公司运作', sysdate(), sysdate());
